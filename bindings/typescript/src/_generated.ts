...
export const TRANSCRIBE_VAD_OFF = 0;
export const TRANSCRIBE_VAD_SILERO = 1;
export const TRANSCRIBE_VAD_ENERGY = 2;
...
export const TRANSCRIBE_EXT_KIND_SORTFORMER_PUSH_STREAM = 1397769811;
...
export function defineTypes(koffi: any): Record<string, any> {
  ...
  T['transcribe_vad_params'] = koffi.struct({ struct_size: 'uint64_t', mode: 'int', dll_path: 'char *', weight_path: 'char *', backend: 'int', device_id: 'int', n_threads: 'int', max_chunk_ms: 'int64_t', merge_gap_ms: 'int64_t', padding_ms: 'int64_t', silero_threshold: 'float', silero_min_speech_ms: 'int64_t', silero_min_silence_ms: 'int64_t' });
  T['transcribe_vad_segment'] = koffi.struct({ start_ms: 'int64_t', end_ms: 'int64_t', confidence: 'float' });
  T['transcribe_run_params'] = koffi.struct({ struct_size: 'uint64_t', task: 'int', timestamps: 'int', pnc: 'int', itn: 'int', diarize: 'int', language: 'char *', target_language: 'char *', keep_special_tags: 'bool', family: 'void *', spec_k_drafts: 'int32_t', vad: T['transcribe_vad_params'] });
  ...
  T['transcribe_sortformer_push_stream_ext'] = koffi.struct({ ext: T['transcribe_ext'], preset: 'int' });
...
export const FUNCTION_SIGNATURES: Record<string, FnSig> = {
  ...
  'transcribe_free_vad': { ret: 'void', args: ['struct transcribe_vad_segment *'] },
  ...
  'transcribe_set_progress_callback': { ret: 'void', args: ['struct transcribe_session *', 'transcribe_progress_callback', 'void *'] },
  'transcribe_sortformer_push_stream_ext_init': { ret: 'void', args: ['struct transcribe_sortformer_push_stream_ext *'] },
  'transcribe_sortformer_push_stream_get_tentative': { ret: 'transcribe_status', args: ['const struct transcribe_session *', 'int', 'struct transcribe_speaker_segment *'] },
  'transcribe_sortformer_push_stream_n_tentative': { ret: 'int', args: ['const struct transcribe_session *'] },
  ...
  'transcribe_vad': { ret: 'transcribe_status', args: ['const float *', 'int', 'int', 'const struct transcribe_vad_params *', 'struct transcribe_vad_segment **', 'int64_t *'] },
